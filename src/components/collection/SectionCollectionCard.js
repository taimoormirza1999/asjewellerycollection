    ...
    <div className="col-md-3 col-6 col-sm-6 c" data-aos="zoom-in-up">
          <div className="card">
            <a href="productList.php?id=2">
              <img src={image} className="card-img-top img-fluid best-seller-collection img-fluid" id="img1" alt="..."  height="300px" />
            </a>
            <a href="productList.php?id=2">
              <h5 className="card-title text-center">
                <a className="product-info__caption " href="productList.php?id=2" itemprop="url">
                  <div className="product-details">
                    <span className="title text-center" itemprop="name">{text}</span>
